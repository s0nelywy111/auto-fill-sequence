# INSERT A SEQUENTIAL NUMBER OR WORD / АВТОМАТИЧЕСКАЯ ВСТАВКА ЧИСЕЛ И СЛОВ 🔢
...
3. Type setValues('your values') and press Enter
...
3. Введите setValues('ваши значения') и нажмите Enter
